...
public class PID extends Subsystem implements RobotMap{
	...
	public void goDistance(double targetDistance) {
		...
		*/
		...
		leftController.set(ControlMode.PercentOutput,-1*((left_proportion+integral+derivative)*RobotMap.CONTROLLER_CONSTANT_L));
		rightController.set(ControlMode.PercentOutput,((right_proportion+integral+derivative)*RobotMap.CONTROLLER_CONSTANT_R));
